...
import { FlowPageLayoutElementV31, FlowTextInput} from "@app/model/convs-mgr/stories/flows";
...
export function _CreateFlowTextInputForm(_fb: FormBuilder, blockData?: FlowTextInput ): FormGroup 
{
  return _fb.group({
    name: [blockData?.name ?? "", Validators.required],
      label: [blockData?.label ?? "", Validators.required],
